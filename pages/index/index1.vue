<template>
	<view class="container">
		...
		<!-- 分类推荐楼层 -->
		<view class="f-header m-t" v-if="home_recommend_products.length" @click="goCategory">
		...
		<view class="hot-floor" v-for="(row, index) in home_recommend_products" :key="index">
			<view class="floor-img-box">
				<image class="floor-img" :src="row.image" mode="scaleToFill"></image>
			</view>
...
<script>
	...
	export default {
		...
		computed: {
			...mapState({
				home_recommend_products: state => state.home_recommend_products
			})
		},
		methods: {
			...
			swiperChange(e) {
				...
				this.titleNViewBackground = this.carouselList[index].params.color || '';
			},
